...
//		titleLabel.setForeground(new Color(255, 255, 255));
		JLabel explanationLabel = new JLabel(
				...
				+ "The Minotaur was scarier than you thought, so now you have to run!<br>"
				+ "How the game works: <br>"
				+ "The Minotaur knows the best way to get to the exit, but starts one step behind you.<br>"
				+ "You must find the most efficient way to the end of the maze<br>"
				+ "<br>"
				+ "		1. Your starting position is marked in green<br>"
				+ "		2. Your end position is marked in orange<br>"
				...
				+ "		7. There are three difficulty settings below. Choose one.<br>"
				+ "<br>"
				+ "Get to the end of the maze and save your bacon! Otherwise, you're toast."
				+ "<html/>");
