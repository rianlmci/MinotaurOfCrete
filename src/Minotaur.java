...
/**
 * The antagonist of the maze, the minotaur! It moves around the maze in a set
 * path to try and beat the player to the exit of the maze!
 * 
...
public class Minotaur {
	...
	/**
	 * Sets up the best path for the minotaur to take to the exit of selected the
	 * maze.
	 * 
	...
	public void setBestPath(MazeDifficulty difficulty) {
		...
		case HARD:
			...
			setBestPathHelper(graphFile, 11, 4); // TODO: Files, Ent/Exit.
			break;
		default:
	...
	/**
	 * Moves the minotaur one step ahead of the player (aka setter for stepsTaken)
	 * 
	...
	/**
	 * Indicate whether the minotaur has reached the end of the maze
	 * 
	 * @return true if minotaur has reached the end of the maze; else false
	 */
	...
	/**
	 * Provide feedback dialogue to the user about the minotaur's location
	 * 
